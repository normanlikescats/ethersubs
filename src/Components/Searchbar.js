    ...
    <div className="w-10/12 lg:w-1/2">
      <form className="flex flex-col">
        ...
        <div className="flex flex-row items-center">
          <input type="text" id="search-field" value={input} onChange={handleChange} className="px-2 py-0.25 w-full h-8 font-raleway text-black rounded-md focus:outline-none shadow-md"/>
