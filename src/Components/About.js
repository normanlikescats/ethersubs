...
export default function About(){
  return(
    <div className="z-10 md:px-16 xl:px-28 px-8 flex flex-col justify-start text-left">
      <h1 className="z-10 font-lilita text-3xl 2xl:text-5xl xl:text-4xl">About Us</h1>
      <h2 className="z-10 pt-6 font-lilita text-xl 2xl:text-3xl xl:text-2xl">What is EtherSubs?</h2>
      <p className="z-10 pt-3 font-raleway text-m 2xl:text-xl xl:text-l">
      ...
      <h2 className="z-10 pt-12 font-lilita text-xl 2xl:text-3xl xl:text-2xl">How Does EtherSubs Work?</h2>
      <p className="z-10 pt-3 font-raleway text-m 2xl:text-xl xl:text-l">
      ...
      <h2 className="z-10 pt-12 font-lilita text-xl 2xl:text-3xl xl:text-2xl">How Do I Use EtherSubs?</h2>
      <p className="z-10 pt-3 pb-16 font-raleway text-m 2xl:text-xl xl:text-l">
      ...
      <img src={bubbles} className="z-0 opacity-0 lg:opacity-20 fixed top-0 right-0 h-screen" alt=""/>
      <img src={bubbles} className="z-0 opacity-20 fixed top-0 left-1/4 lg:left-0 h-screen" alt=""/>
    </div>
  )
}